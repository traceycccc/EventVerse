...
// const HubSearchingBar = ({ placeholder }) => {
...
//         flexDirection: 'row',
//         alignItems: 'center',
//         backgroundColor: colors.searchBar, // Light blue background
//         borderRadius: 40,
...
// export default HubSearchingBar;
...
// const HubSearchingBar = ({ placeholder, onResultSelect }) => {
//     const [searchQuery, setSearchQuery] = useState('');
//     const [showResults, setShowResults] = useState(false);
//     const searchResults = [
//         'AAA',
...
const HubSearchingBar = ({ placeholder, onResultSelect, onBackPress }) => {
    const [searchQuery, setSearchQuery] = useState('');
    const [showResults, setShowResults] = useState(false);
    const searchResults = [
        'Give suggestions on welcoming party',
        'Give applause to the new committee!',
    ];
