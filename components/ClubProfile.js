...
// const ClubProfile = ({ wallpaperImage, clubImage, clubName, membersCount, aboutText, isMember, onJoinPress, links, galleryImages }) => {
...
//                 <SmallButton title={isMember ? 'Joined' : 'Join Club'} onPress={onJoinPress} disabled={isMember} />
//             </View>
...
// import React, { useState } from 'react';
// import { View, Text, Image, StyleSheet, ScrollView, Dimensions, TouchableOpacity, Modal, Alert } from 'react-native';
// import SmallButton from './SmallButton';
// import InfoElement from './InfoElement';
// import colors from '../colors';
...
// const ClubProfile = ({ wallpaperImage, clubImage, clubName, membersCount, aboutText, isMember, onJoinPress, onLeavePress, joinState, links, galleryImages }) => {
//     const [isModalVisible, setModalVisible] = useState(false);
//     const [selectedImage, setSelectedImage] = useState(null);
//     const [buttonState, setButtonState] = useState(joinState);
...
//                 <SmallButton
//                     title={buttonState}
//                     onPress={buttonState === 'Leave Club' ? handleLeavePress : handleJoinPress}
...
//     const handleLeavePress = () => {
//         setButtonState('Join Club');
//         onLeavePress(); // Trigger leave action
//     };
...
//     const [isModalVisible, setModalVisible] = useState(false);
//     const [selectedImage, setSelectedImage] = useState(null);
//     const [buttonState, setButtonState] = useState(joinState ?? 'Join Club'); // Default state is "Join Club"
